...
'''
The following function extracts an image from a video and then call 
the function that extracts the face rectangle from the image and display the rectangle above the image.
'''
...
print(len(train_subsample_video))
...
play_video(DATA_FOLDER + '/' + TRAIN_SAMPLE_FOLDER + '/' + fake_videos[0])
